...
/* ─── Animated Input ─── */
function FormInput({ icon, type, placeholder, value, onChange, rightSlot, label, hint }) {
    ...
    <div style={{
      ...
      <div style={{ marginBottom: 32, textAlign: 'center' }}>
        ...
        <h2 style={{
          ...
          /* glowing title treatment from NexusGate */
        ...
        <p style={{
          ...
          Access the Bhopal Smart City portal to manage<br />services and monitor infrastructure data.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
        <div style={{ animation: 'fadeSlideUp 0.5s 0.3s both' }}>
          <FormInput
            ...
            icon={<Mail size={17} />}
            type="email"
            placeholder="officer@bhopal-sc.gov.in"
            value={email}
        ...
        <div style={{ animation: 'fadeSlideUp 0.5s 0.38s both' }}>
          <FormInput
            label="Password"
            icon={<Lock size={17} />}
            ...
            hint={
              <a href="#" style={{ fontSize: 11, fontFamily: "'JetBrains Mono', monospace", color: 'rgba(172,244,164,0.7)', textDecoration: 'none', letterSpacing: '0.04em' }}>
                Forgot password?
              </a>
            }
            rightSlot={
        ...
        {/* Remember me */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, animation: 'fadeSlideUp 0.5s 0.44s both' }}>
          <Toggle checked={remember} onChange={() => setRemember(v => !v)} />
          <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.65)', fontFamily: "'DM Sans', sans-serif", cursor: 'pointer' }} onClick={() => setRemember(v => !v)}>
            Remember me
          </span>
        </div>

        {/* Submit button — with NexusGate pulse on hover */}
        <button
          type="submit"
      ...
      {/* Divider */}
      <div style={{ position: 'relative', margin: '28px 0 22px', display: 'flex', alignItems: 'center', animation: 'fadeSlideUp 0.5s 0.56s both' }}>
      ...
      <button
        style={{
          ...
          animation: 'fadeSlideUp 0.5s 0.62s both',
        }}
      ...
      {/* Register */}
      <p style={{ marginTop: 24, textAlign: 'center', fontSize: 13, color: 'rgba(255,255,255,0.45)', fontFamily: "'DM Sans', sans-serif", animation: 'fadeSlideUp 0.5s 0.68s both' }}>
        New citizen to Bhopal Smart City?{' '}
...
/* ─── Page ─── */
export default function LoginPage({ videoUrl, onSubmit }) {
  // fallback video — user replaces with their own
